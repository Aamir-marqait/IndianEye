    ...
    <div className="min-h-screen bg-black flex items-center justify-center py-12 md:py-16 lg:py-20 px-4 md:px-6 lg:px-8">
      <div className="w-full max-w-[1100px] flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 md:gap-12 lg:gap-20">
        ...
        <div className="lg:w-1/2 w-full flex flex-col justify-center">
          <h1 className="font-(family-name:--font-albert-sans) font-semibold text-[32px] md:text-[40px] lg:text-[48px] leading-[1.2] md:leading-[1.1] lg:leading-[100%] text-white mb-4 md:mb-5 lg:mb-6">
            Contact Us
          </h1>
          <p className="font-(family-name:--font-albert-sans) font-normal text-[16px] md:text-[18px] lg:text-[20px] leading-[150%] text-white mb-6 md:mb-7 lg:mb-8">
          ...
          <div className="flex flex-col lg:flex-row gap-6 md:gap-8 lg:gap-12 mt-2 md:mt-3 lg:mt-4">
            <div>
              ...
              <div className="flex items-start gap-2">
                ...
                />
                <span className="font-inter font-normal text-[14px] md:text-[15px] lg:text-base leading-[1.5] md:leading-6 text-white">
        ...
        >
          <h2 className="font-(family-name:--font-albert-sans) font-bold text-[24px] md:text-[26px] lg:text-[30px] leading-[1.4] md:leading-[1.5] lg:leading-[60px] text-white">
            Get In Touch :
          </h2>
