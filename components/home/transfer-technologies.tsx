...
export default function TransferTechnologies() {
  return (
    <section className="w-full relative bg-black py-16">
      <div className="absolute top-0 right-0 w-32 h-32 md:w-120 md:h-120  pointer-events-none">
        <Image
          src="/home/right.png"
      ...
      <div className="mx-auto px-6 w-full max-w-[1100px]">
        {/* Title */}
        <h2 className="font-albert-sans text-center text-[48px] font-bold leading-none tracking-[-0.04em] text-white mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            ...
            <div className="w-full">
              <div className="relative  overflow-hidden">
                <div className="w-full h-64 md:h-[360px] lg:h-80 relative">
                  <Image
            ...
            <div className="w-full">
              <div className="bg-transparent rounded-xl p-4 md:p-6">
                <h3 className="font-albert-sans text-[28px] font-semibold leading-none tracking-normal text-white mb-4">
                  Where innovation meets trusted security!
                </h3>

                <p className="font-albert-sans text-base font-normal leading-[150%] tracking-normal text-white max-w-prose">
